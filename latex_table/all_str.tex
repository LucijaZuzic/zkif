...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{cs_reverse_svmPoly}
	\label{tab:cs_reverse_svmPoly}
\end{table}
...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{cs_reverse_C5.0}
	\label{tab:cs_reverse_C5.0}
\end{table}
...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{cs_reverse_nb}
	\label{tab:cs_reverse_nb}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|}
		...
		\multirow{7}{*}{\rotatebox{90}{Statistics}} & Sen & $100\%$ & $100\%$ & $100\%$ & $100\%$ & $100\%$ \\ \cline{2-7}
		 ...
		 & BA & $100\%$ & $100\%$ & $100\%$ & $100\%$ & $100\%$ \\ \hline
	\end{tabular}
	\caption{cs_reverse_nnet}
	\label{tab:cs_reverse_nnet}
\end{table}
...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{cs_reverse_pls}
	\label{tab:cs_reverse_pls}
\end{table}
...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{cs_reverse_fda}
	\label{tab:cs_reverse_fda}
\end{table}
...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{cs_reverse_pcaNNet}
	\label{tab:cs_reverse_pcaNNet}
\end{table}
...
\begin{table}[!ht]
	...
	\end{tabular}
	\caption{stats_reverse}
	\label{tab:stats_reverse}
\end{table}
